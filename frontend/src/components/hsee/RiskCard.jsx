      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 grid gap-3 lg:grid-cols-[1fr_1fr_160px]">
            <RiskMeter label="ProbabilitÃ©" value={risk.probability} levelKey={risk.level.key} />
            <RiskMeter label="GravitÃ©" value={risk.severity} levelKey={risk.level.key} />

            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3">
              <p className="text-xs font-medium text-slate-600">CriticitÃ©</p>
              <div
          ...
          <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="grid gap-3 text-sm md:grid-cols-2 md:gap-6">
              ...
              <div>
                <p className="text-[10px] uppercase tracking-[0.16em] text-slate-400">Ã‰chÃ©ance</p>
