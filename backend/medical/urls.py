...
from .views import (
    ...
    ExamenComplementaireListByDossierView,
    ...
    FicheMedicalePdfView,
    CertificatMedicalPdfView,
    OrdonnancePdfView,
    BonChauffeurPdfView,
    ControleMedicalRecordPdfView,
    DemandeExpertiseRecordPdfView,
...
urlpatterns = [
    ...
    path("fiche/<int:collaborateur_id>/pdf/", FicheMedicalePdfView.as_view()),
    path("certificats/<int:pk>/pdf/", CertificatMedicalPdfView.as_view()),
    path("ordonnances/<int:pk>/pdf/", OrdonnancePdfView.as_view()),
    path("bon-chauffeurs/<int:pk>/pdf/", BonChauffeurPdfView.as_view()),
    path("controles-medicaux/<int:pk>/pdf/", ControleMedicalRecordPdfView.as_view()),
    path("demandes-expertise/<int:pk>/pdf/", DemandeExpertiseRecordPdfView.as_view()),
    ...
    path("dossiers/<int:dossier_id>/examens-complementaires/", ExamenComplementaireListByDossierView.as_view()),
